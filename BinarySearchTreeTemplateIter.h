#pragma once
//Important Notes: 
//Note 0: some parts of the code are taken from the course textbook.  (Data Structures and Algorithms in C++ Second Edition by
...
template <class Elem>
class LinkedBinarySearchTree {  // ADT
...
{
	return Iterator(_root->left); // return the virtual root
}
